...
#CONFIG_FILE=configs/swin_tiny_patch1_window2_cifar_ffcv.yaml
...
CUDA_VISIBLE_DEVICES=0,1,2,3 WORLD_SIZE=$NUM_PROC python -m torch.distributed.launch --nproc_per_node $NUM_PROC --master_port 12347 \
